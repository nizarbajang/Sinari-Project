...
<body>
    ...
    <nav id="sidebar-desktop" class="d-none d-lg-block">
        ...
        <ul class="list-unstyled components p-0">
            <li class="{{ Request::routeIs('investor.dashboard') ? 'active' : '' }}">
                <a href="{{ route('investor.dashboard') }}"><i class="fas fa-home me-2"></i>
            ...
            <li
                ...
                <a href="{{ route('investments.projects.index') }}">
                    <i class="fas fa-search-dollar me-2"></i> <span>Cari Proyek</span>
                </a>
            </li>

            <li class="{{ Request::routeIs('investments.history') ? 'active' : '' }}">
                <a href="{{ route('investments.history') }}">
                    <i class="fas fa-history me-2"></i> <span>Riwayat Investasi</span>
                </a>
            </li>

            {{-- MENU BARU — LAPORAN PETERNAK --}}
            <li class="{{ Request::routeIs('investor.reports.index') ? 'active' : '' }}">
                <a href="{{ route('investor.reports.index') }}">
                    <i class="fas fa-file-alt me-2"></i> <span>Laporan Peternak</span>
                </a>
            </li>
        </ul>
    </nav>
    ...
    <div class="offcanvas offcanvas-start offcanvas-admin" tabindex="-1" id="sidebar-mobile"
        ...
        <div class="offcanvas-header">
            <h5 class="offcanvas-title">Sinari<span style="color: var(--color-primary)">Farm</span></h5>
        ...
        <div class="offcanvas-body">
            <ul class="list-unstyled components p-0">
                ...
                {{-- MENU BARU MOBILE — LAPORAN PETERNAK --}}
                <li class="{{ Request::routeIs('investor.reports.index') ? 'active' : '' }}">
                    <a href="{{ route('investor.reports.index') }}"><i class="fas fa-file-alt me-2"></i> Laporan
                        Peternak</a>
                </li>
            </ul>
        </div>
    ...
    <div id="content-wrapper">
        <nav class="navbar navbar-expand-lg bg-white rounded shadow-sm mb-4 mx-3">
            <div class="container-fluid">
                ...
                <div class="d-flex ms-auto">
                    ...
                    "
                        class="me-3 text-primary text-decoration-none" style="font-size: 1.3rem;">
                        <i class="fas fa-user-circle"></i>
                        <span class="me-3 text-primary d-none d-sm-inline">Halo,
                            {{ Auth::user()->name ?? '' }}!</span>
                    </a>
